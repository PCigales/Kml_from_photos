...
- option 1 = use Windows Presentation Foundation for thumbnail generation and metadata extraction (recommended): copy "kmlz.ps1" (for use in Google Earth Desktop) and/or "kmlz-andro" (for use in Google Earth Android) in "C:\Users\\...\AppData\LocalLow\Google\GoogleEarth"
